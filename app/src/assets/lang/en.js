export default {
    ...
    home_027:"Offline",
    home_028: "Number of invitations(people)",
    home_029:"Amount earned(ENC)",
    home_030:"View details",
    home_031:"Task number",
    home_032:"Task status",
    home_033: "Please invite the users with the following numbers to your group owner, and after the invitation ends, submit your group link. We will use AI to verify whether your group members meet the requirements, and according to the members who meet the requirements The quantity settles the Bouns for you.",
    ...
    spre_003:"Today's Task",
    spre_004:"Yesterday's Bouns",
    ...
    pay_004: "Withdrawable Amount (yuan)",
    ...
    pay_013:"Bank Card",
    pay_014:"TRX",
    pay_015: "The current amount of cash that can be withdrawn is {value} yuan",
    pay_016:"Withdrawal amount",
    ...
    other_038: "* After scanning the QR code on WeChat on the mobile phone and clicking to confirm, you can click to close it.",
    other_039:"* Wait 3-5 minutes, click Refresh List to check WeChat status",
