        ...
        <div class="continer_main">
            ...
            <div class="group_continer" style="margin-left: 20px;">
                ...
                <u-table @sort-change="sorthandle" :data="accountDataList" row-key="id" use-virtual border :height="autoHeight" v-loading="loading"
                    ...
                    <u-table-column prop="nick_name" :label="$t('sys_g022')" :show-overflow-tooltip="item.showOverflow" minWidth="100">
                        <template slot-scope="scope">
                    ...
                    <u-table-column prop="fuser_name" :label="$t('sys_m068')" :show-overflow-tooltip="item.showOverflow" minWidth="100">
                        <template slot-scope="scope">
