...
<template>
  ...
  import { getaimessagetglist,getsysconfig,upsysconfig,doaimessagetg,dooutexcel } from '@/api/task'
  ...
  export default {
    ...
    methods: {
      ...
      getTaskList(num) {
        ...
        getaimessagetglist(params).then(res => {
          this.loading = false;
