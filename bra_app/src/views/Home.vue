    ...
    computed: {
        ...
        taskNameOption() {
            return [
                ...
                {name:this.$t('home_187'),live1:2,live2:1,type:2,g_num:5,status:null,task_info_id:null,award:this.$t('home_180',{value:'20%'}),btn:this.$t('home_057'),desc:this.$t('home_180')},
