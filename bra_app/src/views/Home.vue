...
export default {
    ...
    computed: {
        ...
        taskNameOption() {
            return [
                {},
                {name:this.$t('home_168'),live1:1,live2:1,type:1,g_num:30, status:null,task_info_id:null/*,tips:this.$t('home_207')*/,award:this.$t('home_009'),btn:this.$t('home_005'),desc:this.$t('home_051')},
