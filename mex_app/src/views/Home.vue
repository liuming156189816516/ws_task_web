            ...
            <div class="task_main w_f flex-item flex-dir-c">
                <div class="task_item w_f flex-item flex-dir-c" v-for="(item,idx) in taskOption" :key="idx">
                    ...
                    <div class="task_live flex-item flex-align font_22">
                        ...
                        <div class="task_live_2 flex-item flex-align" v-if="item.type==4||item.type==3||item.type==5">
    ...
    computed: {
        ...
        taskNameOption() {
            return [
                ...
                {name:this.$t('home_044'),live1:2,live2:1,type:3,g_num:30,status:null,task_info_id:null,award:this.$t('home_139'),btn:this.$t('home_056'),desc:this.$t('home_049')},
                ...
                {name:this.$t('home_145'),live1:2,live2:1,type:5,g_num:30,status:null,task_info_id:null,award:this.$t('home_139'),btn:this.$t('home_056'),desc:this.$t('home_049')},
            ]
        },
        taskStatusOption() {
