...
export default {
    ...
    computed:{
        ...
        profitType(){
            return [{lable:this.$t('other_052'),value:-1},{lable:this.$t('other_025'),value:1 },{lable:this.$t('other_026'),value:2 },{lable:this.$t('spre_023'),value:3},{lable:this.$t('other_027'),value:8 },{lable:this.$t('other_028'),value:9 }];
        },
        taskOption(){
