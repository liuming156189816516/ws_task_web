export default {
    ...
    home_063:"5、Should you have any other questions or queries, kindly contact our customer support services for more assistance",
    ...
    home_075:"Open your WhatsApp, tap 'New Group' (for easier management, it's recommended to give the group a distinct name). Select the contacts you imported into your phone's address book and add them to the group. Note that the contacts will contain the same task code as the “Current Task Number” shown on the upper left of the page.",
