export default {
    ...
    home_059:"1、Before participating in any task, please log in to your account. If you don't have an account, you can click here to sign up",
    ...
    home_061:"3、Upon successfully completing a task and passing system verification, bonuses will be distributed to you. You can view bonus information through <Account -> 'Earnings Records'> or the< 'Records' >module on the task details page",
    ...
    home_064:"1、Only 5 times/day for withdraws",
    home_065:"2、You could apply for withdraw only when your asset is up to 200 or above",
