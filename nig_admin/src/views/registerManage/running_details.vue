        ...
        <div class="continer_main">
            <div class="group_continer">
                ...
                <u-table :data="accountDataList" border height="760" v-loading="loading"
                    ...
                    <u-table-column prop="task_record_id" :label="$t('sys_m065')" minWidth="100">
                        <template slot-scope="scope">
                            {{scope.row.task_record_id||"-" }}
                        </template>
                    </u-table-column>
    ...
    methods: {
        ...
        initBillList(num) {
            ...
            getbillrecordlist(params).then(res => {
                ...
                this.bounty_amount=res.data.bounty_amount||0;
                this.com_amount=res.data.commission_amount||0;
