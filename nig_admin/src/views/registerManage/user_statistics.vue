        ...
        <div class="detail_card">
            ...
            <el-table :data="statisticsList" border v-loading="loading" minHeight="max-content" element-loading-spinner="el-icon-loading" style="width: 100%;">
                ...
                <el-table-column prop="statis_time_str" :label="$t('sys_m090')" minWidth="140">
                    <template slot-scope="scope">
                        {{ scope.row.gj_data_num||0 }}/{{scope.row.data_num}}/{{scope.row.pull_fan_data_num}}
                    </template>
                </el-table-column>
                <el-table-column prop="statis_time_str" :label="$t('sys_m102')" minWidth="140">
                    <template slot-scope="scope">
                        {{ scope.row.gj_bounty_amount||0 }}/{{scope.row.bounty_amount}}/{{scope.row.pull_fan_bounty_amount}}
                    </template>
                </el-table-column>
                <el-table-column prop="statis_time_str" :label="$t('sys_m103')" minWidth="140">
                    <template slot-scope="scope">
                        {{ scope.row.gj_commission_amount||0 }}/{{scope.row.commission_amount}}/{{scope.row.pull_fan_commission_amount}}
                    </template>
                </el-table-column>
        ...
        <div class="continer_main">
            <div class="group_continer">
                ...
                <el-table :data="accountDataList" row-key="id" use-virtual border height="760" v-loading="loading" ref="serveTable"
                    ...
                    <el-table-column prop="today_new_active_user_num" :label="$t('sys_m101')" minWidth="100" />
                    <el-table-column prop="today_active_user_num" :label="$t('sys_m088')" minWidth="100" />
                    <el-table-column prop="view_account_num" :label="$t('sys_mat116')" minWidth="100" />
                    ...
                    <el-table-column prop="group_total_num" :label="$t('sys_m090')" minWidth="160">
                        <template slot-scope="scope">
                            {{ scope.row.gj_data_num +"/"+scope.row.data_num +"/"+scope.row.pull_fan_data_num }}
                        </template>
                    </el-table-column>
                    <el-table-column prop="bouns_total_num" :label="$t('sys_m102')" minWidth="140">
                        <template slot-scope="scope">
                            {{ scope.row.gj_bounty_amount +"/"+scope.row.bounty_amount +"/"+scope.row.pull_fan_bounty_amount }}
                        </template>
                    </el-table-column>
                    <el-table-column prop="comm_total_num" :label="$t('sys_m103')" minWidth="140">
                        <template slot-scope="scope">
