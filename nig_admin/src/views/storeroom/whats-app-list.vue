          ...
          <div class="close_inherit">
            <div>
              ...
              >
                ...
                <u-table-column :label="$t('sys_g027')" min-width="140" prop="account" />
                <u-table-column :label="$t('sys_l017')" min-width="140" prop="staff_no" show-overflow-tooltip />
              </u-table>
            ...
            <div>
              ...
              >
                <u-table-column type="selection" width="40" />
                <u-table-column :label="$t('sys_g027')" min-width="140" prop="account" />
                <u-table-column :label="$t('sys_g108')" min-width="140" prop="group_name" show-overflow-tooltip />
              </u-table>
              <div class="footer_btn">
