...
export default {
    ...
    computed: {
        ...
        taskNameOption() {
            return [
                {},
                {name:this.$t('home_168'),live1:1,live2:3,type:1,g_num:10, status:null,task_info_id:null,award:this.$t('home_139',{value:10}),btn:this.$t('home_056'),desc:this.$t('home_049')},
